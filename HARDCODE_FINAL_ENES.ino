...
void setup() {
    ...
    */
    ...
    //moveToMission();
    colorSensorRun();
    Enes100.println("now pump water");
    pumpWater();
    digitalWrite(pumpControlPin, 150);
}
...
boolean colorSensorRun(){
  ...
  */
  ...
  Enes100.println("Pollutant Found");
...
void pumpWater (){
  ...
  // Debugging output
   if(value<=100){
    Enes100.println("Motor level: Empty" );
    Enes100.println(value);
  }
  else if(value>500 && value<=580){
    Enes100.println("Motor level: 30mm " );
    Enes100.println(value);
  }
  else if(value>580 && value<=610){
      Enes100.println("Motor level: 40mm");
    Enes100.println(value);
  }
  else if(value>610){
    Enes100.println("Motor level: 50mm");
    Enes100.println(value);
  }else{
    Enes100.println("Water Level: 30mm");
  }
 

  
  delay(5);
  Enes100.println("water pumped");
